...
int main()
{
    ...
    float triangleVertices[] = { -0.5f, -0.8f, 0.0f, 0.0f, 0.8f,
        0.0f, 0.7f, -0.9f, 0.0f };
    ...
    if (compilationSucceeded == GL_TRUE) {
        ...
        std::cout << "Vertex shader compilation failed: " << compilationLog
                  << std::endl;
    }
    ...
    if (compilationSucceeded == GL_TRUE) {
        ...
        std::cout << "Fragment shader compilation failed: " << compilationLog
                  << std::endl;
    }
